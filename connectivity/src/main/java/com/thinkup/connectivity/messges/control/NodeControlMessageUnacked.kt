...
class NodeControlMessageUnacked(private val action: Byte, private val timeout: Int,
                                appKey: ApplicationKey, modelId: Int, compId: Int,
                                private val destination: String? = DYNAMIC_MASK, params: ByteArray = byteArrayOf()) :
